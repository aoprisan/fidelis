/**
 * Regression guard: the refactored simulation must reproduce the ORIGINAL
 * single-file backtester's outputs exactly. `__fixtures__/golden.json` was
 * generated by running the original index.html logic in Node over a full
 * scenario matrix (every start date x strategy x donor x reinvest) plus a few
 * detailed leg dumps. If any of these change, an observed output changed.
 */
